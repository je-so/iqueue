...
Additional queue state is stored in the two logic variables *next* and *nrofmsg*. Both logic variables are encoded 
in one physical variable named next_and_nrofmsg to allow for a single *atomic_compare_exchange* operation.
